...
# Installer for the SPI extension on Debian Trixie (and compatible Ubuntu / Raspberry Pi OS).
...
header() {
    echo "=========================================="
    echo " SPI Extension Installer (Debian Trixie)"
    echo "=========================================="
    echo ""
}
...
# Ensure <linux/spi/spidev.h> is available (linux-libc-dev).
if ! dpkg -l linux-libc-dev >/dev/null 2>&1 || \
   ! [ -f /usr/include/linux/spi/spidev.h ]; then
